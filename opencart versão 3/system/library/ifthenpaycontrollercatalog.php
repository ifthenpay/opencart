...
class IfthenpayControllerCatalog extends Controller {
	...
	{
        try {
            if (isset($this->session->data['ifthenpayPaymentReturn']) && isset($this->session->data['ifthenpayPaymentReturn']['paymentMethod']) && 
	...
	{
		if (isset($this->session->data['payment_method']['code']) && $this->session->data['payment_method']['code'] === $this->paymentMethod &&
