...
| ------------------------------------- | --------------------------------- |
| Link to download installer .ocmod.zip | [ifthenpay v1.3.0](https://github.com/ifthenpay/opencart/releases/download/1.3.0/ifthenpay.ocmod.zip) |
...
| ------------------------- | ------------------------------ | ------------------------------ |
| ifthenpay v1.0.0 - v1.3.0 | Compatible | Not compatible |
