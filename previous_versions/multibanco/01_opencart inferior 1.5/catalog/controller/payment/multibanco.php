...
class ControllerPaymentMultibanco extends Controller {
	protected function index() {
		$this->language->load('payment/multibanco');
		
		$this->data['button_confirm'] = $this->language->get('button_confirm');
		$this->data['button_back'] = $this->language->get('button_back');
		
		$order_info = $this->model_checkout_order->getOrder($this->session->data['order_id']);
		$this->data['ent']=$this->config->get('multibanco_entidade');
		$this->data['ref'] = $this->GenerateMbRef($this->config->get('multibanco_entidade'),$this->config->get('multibanco_sub_entidade'),$this->session->data['order_id'], $this->currency->format($order_info['total'], $order_info['currency'], $order_info['value'], FALSE));
		$this->data['valor']=$this->currency->format($order_info['total'], $order_info['currency'], $order_info['value'], TRUE);
	...
	public function confirm() {
		...
		$comment  = '<p><b>Entidade:</b> '.$this->config->get('multibanco_entidade').'</p>
		             <p><b>Refer&ecirc;ncia:</b> '.$this->GenerateMbRef($this->config->get('multibanco_entidade'),$this->config->get('multibanco_sub_entidade'),$this->session->data['order_id'], $this->currency->format($order_info['total'], $order_info['currency'], $order_info['value'], FALSE)).'</p>
