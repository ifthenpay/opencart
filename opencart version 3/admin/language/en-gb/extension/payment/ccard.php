...
$_['text_ccard'] = '<a onclick="window.open(\'https:www.ifthenpay.com\');"><img src="view/image/payment/ifthenpay/ccard.svg" class="ccardLogo" alt="Credit Card Logo" title="Credit Card" style="border: 1px solid #EEEEEE; max-width: 35%;" /><br /></a>';
$_['acess_user_documentation'] = 'Access the user documentation.';
$_['create_account_now'] = 'Create an account now!';

//Entry
$_['entry_backofficeKey'] = 'Backoffice Key';
$_['switch_enable'] = 'Enable';
$_['switch_disable'] = 'Disable';
$_['add_new_accounts'] = 'You Add New Accounts to Your Contract?';
...
$_['add_new_accounts'] = 'You Add New Accounts to Your Contract?';
$_['reset_accounts'] = 'Reset Accounts';
$_['reset_account_success'] = 'Ifthenpay account reseted with success!';
