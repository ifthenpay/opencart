...
$_['text_payment'] = 'Pago';
$_['text_success'] = 'Éxito: ¡Has modificado el módulo de pago Multibanco!';
...
$_['refresh_accounts_help'] = 'Actualizar cuentas y mostrar nuevas entidades si están disponibles.';
$_['sandbox_help'] = 'Activa el modo sandbox para probar el módulo sin activar el callback.';
$_['sandbox_mode'] = 'Modo Sandbox';
$_['dontHaveAccount_multibanco'] = '¿No tienes una cuenta de Multibanco?';
$_['requestAccount_multibanco'] = 'Solicitar creación de cuenta Multibanco';
...
$_['entry_multibanco_entidade'] = 'Entidad';
$_['entry_multibanco_SubEntidade'] = 'Subentidad';
$_['choose_entity'] = 'Elige Entidad';
$_['choose_sub_entity'] = 'Elige Subentidad';
...
$_['activate_cancelMultibancoOrder'] = 'Cancelar Pedido Multibanco';
$_['multibancoOrderCancel_help'] = 'Cancelar el pedido de Multibanco después de que los datos de pago expiren.';
$_['payment_multibanco_deadline_help'] = 'Este campo especifica la expiración, en días, de la referencia generada. Selecciona 0 para que la referencia expire a las 23:59 del día en que se genera. Selecciona 1 o más para que la referencia expire después del número de días seleccionado, comenzando a las 23:59 del día en que fue generada.';

$_['show_paymentMethod_logo'] = 'Mostrar el logo del método de pago en el proceso de compra';
$_['entry_multibanco_deadline'] = 'Fecha Límite de Referencia Multibanco';
$_['multibanco_deadline'] = 'Elige Fecha Límite';
...
$_['dontHaveAccount_multibanco_dynamic'] = '¿No tienes una cuenta Multibanco Dinámica?';
$_['requestAccount_multibanco_dynamic'] = 'Solicitar creación de cuenta Multibanco Dinámica';
$_['dontHaveAccount_multibanco'] = '¿No tienes una cuenta de Multibanco?';
$_['requestAccount_multibanco'] = 'Solicitar creación de cuenta Multibanco';

// Error
$_['error_permission'] = 'Advertencia: ¡No tienes permiso para modificar Multibanco!';
...
$_['head_cancel_cron'] = '(Trabajo Cron) Cancelar Pedido Multibanco';
...
$_['error_entity_required'] = 'Advertencia: ¡La entidad es obligatoria!';
$_['error_sub_entity_required'] = 'Advertencia: ¡La subentidad es obligatoria!';
$_['error_dynamic_expiration_required'] = 'Advertencia: ¡La expiración de la referencia dinámica es obligatoria!';
