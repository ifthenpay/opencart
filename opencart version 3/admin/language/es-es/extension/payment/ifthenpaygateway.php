...
$_['requestAccount_ifthenpaygateway'] = 'Solicitar creación de cuenta Ifthenpay Gateway';
...
$_['entry_ifthenpaygateway_order_id'] = 'ID del Pedido';
...
$_['text_disabled_use_title'] = 'Deshabilitado - Usar título del método de pago';
$_['text_enabled_default_logo'] = 'Habilitado - Usar imagen predeterminada';
$_['text_enabled_composite_image'] = 'Habilitado - Usar imagen compuesta generada';
...
$_['entry_ifthenpay_gateway_methods'] = 'Métodos de Pago';
$_['text_ifthenpay_gateway_methods'] = 'Por favor, selecciona una clave de Ifthenpay Gateway para ver este campo.';
$_['entry_ifthenpay_gateway_methods_default'] = 'Métodos de Pago Predeterminados';
$_['text_ifthenpay_gateway_methods_default'] = 'Por favor, selecciona una clave de Ifthenpay Gateway para ver este campo.';
$_['entry_payment_method_selected_default'] = 'Método de pago seleccionado por defecto';
$_['entry_plh_method_selected_default_none'] = 'Ninguno';
$_['entry_deadline'] = 'Fecha límite';
$_['help_entry_deadline'] = 'Fecha límite en días, después de la cual el enlace del gateway expirará. Déjalo vacío si no quieres fecha límite. Si el cronjob de cancelación está activado, el pedido será cancelado.';
$_['entry_btn_close_text'] = 'Texto del botón de cierre del gateway';
$_['btn_close_text'] = 'Cerrar gateway';
...
$_['entry_ifthenpaygateway_ifthenpaygatewayKey'] = 'Clave de Ifthenpay Gateway';
$_['text_request_ifthenpaygateway_method_btn'] = 'Solicitar método de Ifthenpay Gateway';

$_['activate_cancelIfthenpaygatewayOrder'] = 'Cancelar Pedido Ifthenpay Gateway';
$_['IfthenpaygatewayOrderCancel_help'] = 'Cancelar el pedido de Ifthenpay Gateway después de que los datos de pago expiren.';
...
$_['dontHaveAccount_ifthenpaygateway'] = '¿No tienes una cuenta de Ifthenpay Gateway?';
$_['requestAccount_ifthenpaygateway'] = 'Solicitar creación de cuenta Ifthenpay Gateway';
$_['request_new_ifthenpaygateway_method_success'] = 'Correo enviado con éxito solicitando nuevo método de Ifthenpay Gateway.';
$_['request_new_ifthenpaygateway_method_error'] = 'Error al enviar correo solicitando nuevo método de Ifthenpay Gateway.';


// Error
$_['error_permission'] = 'Advertencia: ¡No tienes permiso para modificar Ifthenpay Gateway!';
...
$_['head_cancel_cron'] = '(Trabajo Cron) Cancelar Pedido Ifthenpay Gateway';
$_['text_cancel_cron_desc'] = 'Puedes configurar este cron para cambiar el estado de los pedidos a "Cancelado" si no se paga dentro del plazo después de la confirmación del pedido.';
...
$_['error_key_required'] = 'Advertencia: ¡Clave de Ifthenpay Gateway obligatoria!';
$_['error_invalid_deadline'] = 'Advertencia: ¡Número inválido para la fecha límite!';
$_['error_invalid_payment_methods'] = 'Advertencia: ¡Debe seleccionar métodos de pago!';
$_['error_invalid_gateway_key'] = 'Advertencia: ¡Debe seleccionar una clave de Gateway!';

$_['error_missing_image_edit_dependency_to_create_composite_image'] = 'Advertencia: ¡No se puede generar el logo compuesto del método de pago debido a la falta de dependencias necesarias!';
$_['error_missing_file_permissions_to_create_composite_image'] = 'Advertencia: ¡No se puede generar el logo compuesto del método de pago debido a la falta de permisos de escritura! Por favor, otorga permisos de lectura/escritura a la carpeta /catalog/view/theme/default/image/ifthenpay/';
