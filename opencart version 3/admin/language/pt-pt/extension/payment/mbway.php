...
$_['adminResendMbwayNotification'] = 'Reenviar notificação MB WAY';

$_['entry_mbway_order_id']	= 'ID de encomenda';
...
$_['entry_payment_method_description'] = 'Descrição';
$_['description_help'] = 'Descrição do MB WAY.';
