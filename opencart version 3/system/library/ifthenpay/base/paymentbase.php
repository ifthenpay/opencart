...
abstract class PaymentBase
{
    ...
    public function setTwigVariables(): void
    {
        ...
        if ($this->configData['payment_' . $this->paymentMethod . '_showPaymentMethodLogo'] == '0') {
            ...
            $this->twigDefaultData->setPaymentPanelLogoOrName('<img src="' . $this->ifthenpayGateway->getPaymentLogoUrl($this->paymentMethod, Url::catalogUrl($this->ifthenpayController->config->get('config_secure'))) . '" height="38px">');
        }
    }
