...
// Admin logo
$_['text_ifthenpaygateway'] = '<img src="' . HTTP_CATALOG . 'extension/ifthenpay/admin/view/image/ifthenpaygateway.png" height="30" alt="Ifthenpay - Ifthenpay Gateway" title="Ifthenpay - Gateway"/>';
...
$_['text_no_ifthenpaygateway_accounts_found'] = 'No Ifthenpay Gateway accounts found for this contract.';
$_['text_to_request_a_ifthenpaygateway_account'] = 'To request a Ifthenpay Gateway account for your contract click the button "Request Ifthenpay Gateway Account".';
...
$_['text_hide_payment_method_icon'] = 'Hide payment method icon';
$_['text_show_payment_method_icon'] = 'Show payment method icon';
$_['text_show_composite_payment_method_icon'] = 'Show composite icon of available payment methods';
...
$_['entry_select_gateway_key_to_view_methods'] = 'Please select a Ifthenpay Gateway key to display this field.';
...
// Help texts
$_['help_enable_show_icon_checkout'] = 'Display this payment method icon at checkout, choose "Show composite icon of available payment methods" option to display a combination of all available payment method icons (this may not work as expected with all themes).';
