...
$_['text_no_ifthenpaygateway_accounts_found'] = 'Não foram encontradas contas de Ifthenpay Gateway para este contrato.';
...
$_['text_hide_payment_method_icon'] = 'Ocultar ícone do método de pagamento';
$_['text_show_payment_method_icon'] = 'Exibir ícone do método de pagamento';
$_['text_show_composite_payment_method_icon'] = 'Exibir ícone composito dos métodos de pagamento disponíveis';
...
// Help texts
$_['help_enable_show_icon_checkout'] = 'Exibir o ícone deste método de pagamento no checkout, escolha a opção "Exibir ícone composito dos métodos de pagamento disponíveis" para exibir uma combinação de todos os ícones de métodos de pagamento disponíveis (pode não funcionar como esperado com todos os temas).';
